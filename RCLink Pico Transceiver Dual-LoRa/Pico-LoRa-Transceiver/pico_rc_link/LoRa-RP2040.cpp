...
LoRaClass::LoRaClass() : 
      _spi(SPI_PORT),
      _ss(LORA_DEFAULT_SS_PIN), _reset(LORA_DEFAULT_RESET_PIN), _dio0(LORA_DEFAULT_DIO0_PIN),  _pin_cs(PIN_CS_DEFAULT),
      _frequency(0), 
      _packetIndex(0),
...
int LoRaClass::begin(long frequency) 
{
  ...
  bi_decl(bi_1pin_with_name(_pin_cs, "SPI CS"));
...
void LoRaClass::setPins(int ss, int reset, int dio0, int pin_cs) 
{
  _ss = ss;
  _reset = reset;
  _dio0 = dio0;
