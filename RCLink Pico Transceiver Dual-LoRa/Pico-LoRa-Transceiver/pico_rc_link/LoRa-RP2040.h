...
public:
  ...
  void setPins(int ss = LORA_DEFAULT_SS_PIN, int reset = LORA_DEFAULT_RESET_PIN, int dio0 = LORA_DEFAULT_DIO0_PIN, int pin_cs = PIN_CS_DEFAULT);
...
extern LoRaClass LoRa1;
extern LoRaClass LoRa2;